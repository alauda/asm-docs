...
- The [Bookinfo sample application has been deployed](quickstart/deploy-bookinfo.html).
- A [service mesh has been created](install/create_service_mesh/index.html).
- You have [accessed Bookinfo](quickstart/access-bookinfo.html).
...
1. **Generate traffic**  
   ...
   **Note: ** Replace `GATEWAY_IP_PORT` with the actual IP of your ingress gateway. We have previously obtained the `GATEWAY_IP_PORT` in the [Accessing Bookinfo] section.
