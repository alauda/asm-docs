---
weight: 13
title: How to customize and apply configuration changes to Istio resources?
description: This article will guide you through customizing and applying changes to Istio resources on the platform, enabling capabilities not provided through the platform's UI.
---
...
8. Click <img src='./assets/003point.png' style={{ display: 'inline' }} /> > **Update** on the right of DestinationRule.
