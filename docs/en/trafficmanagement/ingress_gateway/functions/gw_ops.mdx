...
2. Use controls:  
   - Manual refresh: Click ![](/en/img/00metricrefresh.png)  
   - Auto-refresh: Set interval via ![](/en/img/00metricautorefresh.png)  
3. View details:  
   - Toggle chart lines via ![](/en/img/00legend.png)  
   - Adjust thresholds with ![](/en/img/asm/33metricsetting.png)  
