...
2. Use controls:  
   - Manual refresh: Click ![](../assets/00metricrefresh.png)
   - Auto-refresh: Set interval via ![](../assets/00metricautorefresh.png)
3. View details:  
   - Toggle chart lines via ![](../assets/00legend.png)  
   - Adjust thresholds with ![](../assets/33metricsetting.png)  
