...
| UI Control | Action |
|------------|--------|
| ![](/zh/img/333point.png) | Open context menu |
...
|--------|-----------|-----------------|
| Error Rate | \<5% | ![](/zh/img/33metricrefresh.png) |
| Latency | \<500ms | ![](/zh/img/33metricautorefresh.png) |
| Active Connections | ±10% variance | ![](/zh/img/33legend.png) |
