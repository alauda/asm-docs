...
#### Upgrade the Non-Istio Components of the Service Mesh in the Cluster \{#component}
...
#### Deploy the New Version of istiod \{#newistiod}
...
#### Check if there are any EnvoyFilters in the Cluster \{#envoyfilters}
...
#### Upgrade All Istio Data Planes in the Cluster \{#data-planes}
...
1. In the left navigation bar, click **Service Mesh** > **Gateways**.
    **Note**: In the cluster's gateway list, the ![](/00feature.png) icon to the right of **Istio Version** indicates that the data plane proxy of the gateway can be upgraded.
...
4. In the left navigation bar, click **Service List**.
    **Note**: When the ![](/00feature.png) icon appears next to the `Service Name`, it indicates that the Sidecar of the service can be upgraded.
5. Click **Batch Upgrade Sidecars**.
    **Note**: Click the **Upgrade** button to the right of the ![](/00feature.png) icon for the service record to upgrade a single service.
...
#### Decommission the Old Version of istiod in the Cluster \{#oldistiod}
