...
The scenario where the ACP **global** cluster runs **Alauda OS** is not supported.

When the ACP **global** cluster is **Alauda OS**, the **Alauda Service Mesh Essentials** cluster plugin cannot be deployed. In this case, do not continue with the following installation procedure.
:::
