...
1. Refer to [Create a Project](@console-platform-docs/zh/project-usermanual/project/1addproject/) to create a project on the platform that includes the **associated clusters** `c1` and `c2`.

2. Refer to [Create a Namespace](@console-platform-docs/zh/project-usermanual/namespace/1createns/) to create the same named namespace `ns1` in clusters `c1` and `c2`.
