...
{/* TODO: [Set Region for a Cluster](@console-platform-docs/zh/platform-usermanual/clusterall/1cluster/13clustermanagement/#region) */}

* If you need to set the region for a **cluster to be added** to the mesh, refer to [Set Region for a Cluster]().
...
* If you need to set the region for a **cluster already added** to the mesh, follow the steps below:
    ...
    1. Perform the operation [Set Region for a Cluster]().
