...
i18n:
  title:
    zh: 升级服务网格
sourceSHA: 333c52cfeb9521e96c9fd39436d4dc98e6e53141bd6511e5ae0f5f744eb7bf76
---
...
- 如果集群当前的 Kubernetes 版本低于 Istio 升级所需的版本，您需要通过 [升级组件](@console-platform-docs/zh/platform-usermanual/clusterall/1cluster/11upgrade/) 将 Kubernetes 升级到兼容版本。
